...
.DESCRIPTION
    Reflects over the *installed* Bannerlord v1.4.5 assemblies + TAOM.dll and writes two markdown
...
[void]$gm.AppendLine('# GameModel Base Signatures (v1.4.5 snapshot)')
[void]$gm.AppendLine('')
[void]$gm.AppendLine('Auto-generated by tools/snapshot_api_surface.ps1. For each Taom*Model, the base Default*Model')
[void]$gm.AppendLine('and the exact v1.4.5 signature of every method it overrides. The C# compiler already enforces')
...
[void]$pt.AppendLine('# Harmony Patch Target Signatures (v1.4.5 snapshot)')
[void]$pt.AppendLine('')
[void]$pt.AppendLine('Auto-generated by tools/snapshot_api_surface.ps1. Each [HarmonyPatch] / TargetMethod-bearing')
[void]$pt.AppendLine('class in TAOM.dll and the v1.4.5 engine method it patches, resolved the way Harmony resolves it.')
