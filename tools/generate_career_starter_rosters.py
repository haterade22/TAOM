...
CULTURES = {
    "mordor": {
        ...
        "inf":     ["wm_mordor_set1_sword_a01", "wooden_round_shield", "wm_mordor_set1_polearm_a01"],
        "ranged":  ["vlandian_hunting_bow", "bodkin_arrows_a", "wm_mordor_set1_sword_a01"],
        "cavalry": ["wm_mordor_set1_polearm_a01", "wooden_round_shield", "wm_mordor_set1_sword_a01"],
    },
    "isengard": {
        "folder": "isengard",
        "horse": "warg_brown", "harness": "warg_saddle",
        "arrows": "bodkin_arrows_a",
        "inf":     ["iron_sword_t1", "wm_isengard_shield_a01", "wm_gundabad_spear_a01"],
        "ranged":  ["wm_isengard_bow_a01", "bodkin_arrows_a", "iron_sword_t1"],
        "cavalry": ["wm_gundabad_spear_a01", "wm_isengard_shield_a01", "iron_sword_t1"],
    },
    "gundabad": {
        "folder": "gundabad",
        "horse": "warg_brown", "harness": "warg_saddle",
        ...
        "ranged":  ["vlandian_hunting_bow", "bodkin_arrows_a", "wm_gundabad_sword_a01"],
    ...
    "dolguldur": {
        ...
        "horse": "warg_brown", "harness": "warg_saddle",
        "arrows": "bodkin_arrows_a",
        "inf":     ["wm_dol_goldur_1h_sword_a01", "wooden_round_shield", "wm_dol_goldur_axe_a01"],
        "ranged":  ["vlandian_hunting_bow", "bodkin_arrows_a", "wm_dol_goldur_1h_sword_a01"],
        "cavalry": ["wm_dol_goldur_halberd_a01", "wooden_round_shield", "wm_dol_goldur_1h_sword_a01"],
    },
    "erebor": {
        ...
        "cavalry": ["sm_dwarf_erebor_spear_a", "wooden_round_shield", "sm_dwarf_erebor_1h_axe_a"],
    },
    "rivendell": {
        "folder": "rivendell",
        "horse": "saddle_horse", "harness": "leather_horse_harness",
        "arrows": "wm_elven_arrow_v1_a",
        "inf":     ["wm_rivendell_sword_a01", "wooden_round_shield", "wm_rivendell_spear_a01"],
        "ranged":  ["wm_mirkwood_bow_a01", "wm_elven_arrow_v1_a", "wm_rivendell_sword_a01"],
        "cavalry": ["wm_rivendell_spear_a01", "wooden_round_shield", "wm_rivendell_sword_a01"],
    },
    "mirkwood": {
        "folder": "mirkwood",
        "horse": "saddle_horse", "harness": "leather_horse_harness",
    ...
    "vlandia": {  # Rohan (XSLT culture)
        ...
        "horse": "saddle_horse", "harness": "leather_horse_harness",
        "arrows": "bodkin_arrows_a",
        "inf":     ["wm_rohan_ws_sword_a01", "wooden_round_shield", "wm_rohan_ws_spear_a01"],
        "ranged":  ["wm_rohan_ws_bow_starter", "bodkin_arrows_a", "wm_rohan_ws_sword_a01"],
        "cavalry": ["wm_rohan_ws_spear_a01", "wooden_round_shield", "wm_rohan_ws_sword_a01"],
    },
    "empire": {  # Dunland (XSLT culture)
        ...
        "horse": "saddle_horse", "harness": "leather_horse_harness",
        "arrows": "bodkin_arrows_a",
        "inf":     ["iron_sword_t1", "wooden_round_shield", "dunland_caerdh_spear_a"],
        "ranged":  ["vlandian_hunting_bow", "bodkin_arrows_a", "iron_sword_t1"],
        "cavalry": ["dunland_caerdh_spear_a", "wooden_round_shield", "iron_sword_t1"],
    },
    "aserai": {  # Harad (XSLT culture)
        ...
        "horse": "saddle_horse", "harness": "leather_horse_harness",
        "arrows": "bodkin_arrows_a",
        "inf":     ["wm_harad_sword_a01", "wooden_round_shield", "wm_harad_spear_a01"],
        "ranged":  ["wm_harad_bow_a01", "bodkin_arrows_a", "wm_harad_sword_a01"],
        "cavalry": ["wm_harad_spear_a01", "wooden_round_shield", "wm_harad_sword_a01"],
    },
    "khuzait": {  # Rhun (XSLT culture). No prefixed weapons — use vanilla khuzait gear.
        ...
        "horse": "saddle_horse", "harness": "leather_horse_harness",
        "arrows": "bodkin_arrows_a",
        "inf":     ["iron_sword_t1", "wooden_round_shield", "easterling_spear"],
        "ranged":  ["composite_bow", "bodkin_arrows_a", "iron_sword_t1"],
        "cavalry": ["easterling_spear", "wooden_round_shield", "iron_sword_t1"],
    },
    "sturgia": {  # Dale (XSLT culture). No prefixed weapons — use vanilla northern gear.
        ...
        "horse": "saddle_horse", "harness": "leather_horse_harness",
        "arrows": "bodkin_arrows_a",
        "inf":     ["iron_sword_t1", "wooden_round_shield", "northern_spear_1_t2"],
        "ranged":  ["hunting_bow", "bodkin_arrows_a", "iron_sword_t1"],
        "cavalry": ["northern_spear_1_t2", "wooden_round_shield", "iron_sword_t1"],
    },
}
