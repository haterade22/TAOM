"""
Generate character creation equipment rosters for TAOM's 10 custom cultures.

Outputs: Main/_Module/ModuleData/taom_char_creation_equipment.xml
Each culture gets 53 equipment rosters following vanilla Bannerlord patterns.
"""
...
OUTPUT_PATH = os.path.join(
    ...
    "..", "Main", "_Module", "ModuleData", "taom_char_creation_equipment.xml"
)
...
CULTURES = {
    "gondor": {
        ...
        "leg": "sk_gondor_lossarnach_boots_a",
        "leg_alt": "cts_gondor_boot",
        "head_light": "ithilien_hood",
        "head_military": "gondor_solider_helm",
        "gloves": "citidel_guard_gloves",
        "cape": "ithilien_cloak",
...
def main():
    ...
    xml_lines = [
        ...
        '<!--',
        f'  TAOM Character Creation Equipment Rosters ({count} rosters for 10 custom cultures)',
