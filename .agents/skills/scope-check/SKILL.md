...
> **Enforcement level: GUIDANCE.** This is a discipline rule the skill enforces by following its own instructions, not a deterministic gate. There is no hook, plan-vs-delivery diff, or other mechanical verifier. Codex review #29 flagged this honestly: a prose-only rule depends on Codex reading and following it. Treat it as a routing nudge during scope reasoning, not a guarantee.
