...
1. Reads the freeze-dir state file (`.Codex/tmp/freeze/freeze-dir.txt`)
...
- The state file is in `.Codex/tmp/` (gitignored) — boundary clears if you delete the file or run `/unfreeze`
