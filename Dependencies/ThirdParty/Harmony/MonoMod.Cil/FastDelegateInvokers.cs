...
internal static class FastDelegateInvokers
{
	...
	public static (MethodInfo Invoker, Type Delegate)? GetDelegateInvoker(Type delegateType)
	{
		...
		Tuple<MethodInfo, Type> value = invokerCache.GetValue(delegateType, delegate(Type type)
		{
			...
			{
				return new Tuple<MethodInfo, Type>(null, type);
			}
			...
			array[methodSignature.ParameterCount] = type;
			...
			return new Tuple<MethodInfo, Type>(dynamicMethodDefinition.Generate(), type);
		});
