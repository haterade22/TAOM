...
internal sealed class BytePatternCollection : IEnumerable<BytePattern>, IEnumerable
{
	...
	public bool TryMatchAt(ReadOnlySpan<byte> data, out ulong address, [_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int length)
	{
	...
	public bool TryMatchAt(ReadOnlySpan<byte> data, Span<byte> addrBuf, [_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int length)
	{
		if (data.Length < MinLength)
		{
			length = 0;
	...
	public bool TryFindMatch(ReadOnlySpan<byte> data, out ulong address, [_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int offset, out int length)
	{
		if (data.Length < MinLength)
		{
			length = (offset = 0);
	...
	public bool TryFindMatch(ReadOnlySpan<byte> data, Span<byte> addrBuf, [_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int offset, out int length)
	{
		if (data.Length < MinLength)
		{
			length = (offset = 0);
