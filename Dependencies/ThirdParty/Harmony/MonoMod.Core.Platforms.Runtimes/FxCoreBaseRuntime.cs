...
internal abstract class FxCoreBaseRuntime : IRuntime
{
	...
	private static TypeClassification ClassifyRyuJitX86(Type type, bool isReturn)
	{
		...
		if (flag)
		{
			bool flag2 = (uint)(typeCode - 13) <= 1u;
			flag = flag2;
		}
		if (flag)
		{
	...
	public bool RequiresGenericContext(MethodBase method)
	{
		...
		if ((method.IsGenericMethod ? method.GetGenericArguments() : Type.EmptyTypes).Any(IsGenericSharedType))
		{
			return true;
		}
		...
		return (type.IsGenericType ? type.GetGenericArguments() : Type.EmptyTypes).Any(IsGenericSharedType);
	}
	...
	private static bool IsGenericSharedType(Type type)
	{
		if (!type.IsPrimitive)
		{
			if (type.IsValueType)
			{
				...
				{
					return type.GetGenericArguments().Any(IsGenericSharedType);
				}
				return false;
			}
			return true;
	...
	private static bool TryInvokeBclCompileMethodRefl(RuntimeMethodHandle handle)
	{
		...
		bool isEnabled;
		_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler(81, 1, out isEnabled);
		if (isEnabled)
		{
	...
	public virtual void Compile(MethodBase method)
	{
		...
		{
			bool isEnabled;
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogSpamStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogSpamStringHandler(91, 1, out isEnabled);
			if (isEnabled)
			{
			...
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.Spam(ref message);
		}
	}
	...
	protected virtual void OnMethodCompiledCore(RuntimeTypeHandle declaringType, RuntimeMethodHandle methodHandle, ReadOnlyMemory<RuntimeTypeHandle>? genericTypeArguments, ReadOnlyMemory<RuntimeTypeHandle>? genericMethodArguments, IntPtr methodBodyStart, IntPtr methodBodyRw, ulong methodBodySize)
	{
		...
		try
		{
			...
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogSpamStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogSpamStringHandler(28, 3, out isEnabled);
			if (isEnabled)
			{
			...
			{
				_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler message2 = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler(40, 1, out isEnabled);
				if (isEnabled)
				{
		...
		{
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler message3 = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler(31, 1, out isEnabled);
			if (isEnabled)
			{
				message3.AppendLiteral("Error in OnMethodCompiledCore: ");
				message3.AppendFormatted(value2);
			}
