	...
	public IntPtr CreateAlternateEntrypoint(IntPtr entrypoint, int minLength, out IDisposable? handle)
	{
		...
		while (true)
		{
			...
			if (!BlockEncoder.TryEncode(bitness, new InstructionBlock(bufferCodeWriter, instructionList, (ulong)(long)baseAddress), out string errorMessage, out BlockEncoderResult _))
			{
				allocated.Dispose();
				bool isEnabled;
				_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogErrorStringHandler(44, 1, out isEnabled);
				if (isEnabled)
				{
