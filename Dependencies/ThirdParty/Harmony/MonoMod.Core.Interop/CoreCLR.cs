...
internal static class CoreCLR
{
	...
	public class V21
	{
		...
		public unsafe static CorJitResult InvokeCompileMethod(IntPtr functionPtr, IntPtr thisPtr, IntPtr corJitInfo, CORINFO_METHOD_INFO* methodInfo, uint flags, byte** pNativeEntry, uint* pNativeSizeOfCode)
		{
			...
			return ((delegate* unmanaged[Stdcall]<IntPtr, IntPtr, CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult>)(void*)functionPtr)(thisPtr, corJitInfo, methodInfo, flags, pNativeEntry, pNativeSizeOfCode);
		}
	}
	...
	public readonly struct InvokeCompileMethodHookPostPtr
	{
		...
		public unsafe delegate*<IntPtr, IntPtr, IntPtr, V21.CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult, V60.AllocMemArgs*, CorJitResult> InvokeCompileMethodHookPost => (delegate*<IntPtr, IntPtr, IntPtr, V21.CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult, V60.AllocMemArgs*, CorJitResult>)(void*)methodPtr;

		public unsafe InvokeCompileMethodHookPostPtr(delegate*<IntPtr, IntPtr, IntPtr, V21.CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult, V60.AllocMemArgs*, CorJitResult> ptr)
		{
			methodPtr = (IntPtr)ptr;
		}
	}
	...
	public readonly struct InvokeAllocMemPtr
	{
		...
		public unsafe delegate*<IntPtr, IntPtr, V60.AllocMemArgs*, void> InvokeAllocMem => (delegate*<IntPtr, IntPtr, V60.AllocMemArgs*, void>)(void*)methodPtr;

		public unsafe InvokeAllocMemPtr(delegate*<IntPtr, IntPtr, V60.AllocMemArgs*, void> ptr)
		{
			methodPtr = (IntPtr)ptr;
		}
	}
	...
	public class V60 : V50
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)]
		public unsafe delegate CorJitResult CompileMethodHookPostDelegate(IntPtr thisPtr, IntPtr corJitInfo, CORINFO_METHOD_INFO* methodInfo, uint flags, byte** nativeEntry, uint* nativeSizeOfCode, CorJitResult res, AllocMemArgs* allocMemArgs);
		...
		public unsafe static InvokeCompileMethodHookPostPtr InvokeCompileMethodHookPostPtr => new InvokeCompileMethodHookPostPtr((delegate*<IntPtr, IntPtr, IntPtr, CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult, AllocMemArgs*, CorJitResult>)(&InvokeCompileMethodHookPost));

		public unsafe static void InvokeAllocMem(IntPtr functionPtr, IntPtr thisPtr, AllocMemArgs* args)
		{
			if (!(functionPtr == IntPtr.Zero))
			{
				((delegate* unmanaged[Thiscall]<IntPtr, AllocMemArgs*, void>)(void*)functionPtr)(thisPtr, args);
			}
		}
		...
		public new unsafe static CorJitResult InvokeCompileMethod(IntPtr functionPtr, IntPtr thisPtr, IntPtr corJitInfo, CORINFO_METHOD_INFO* methodInfo, uint flags, byte** nativeEntry, uint* nativeSizeOfCode)
		{
			...
			return ((delegate* unmanaged[Thiscall]<IntPtr, IntPtr, CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult>)(void*)functionPtr)(thisPtr, corJitInfo, methodInfo, flags, nativeEntry, nativeSizeOfCode);
		}

		public unsafe static CorJitResult InvokeCompileMethodHookPost(IntPtr functionPtr, IntPtr thisPtr, IntPtr corJitInfo, CORINFO_METHOD_INFO* methodInfo, uint flags, byte** nativeEntry, uint* nativeSizeOfCode, CorJitResult res, AllocMemArgs* pArgs)
		{
			if (functionPtr == IntPtr.Zero)
			{
				return res;
			}
			return ((delegate* unmanaged[Thiscall]<IntPtr, IntPtr, CORINFO_METHOD_INFO*, uint, byte**, uint*, CorJitResult, AllocMemArgs*, CorJitResult>)(void*)functionPtr)(thisPtr, corJitInfo, methodInfo, flags, nativeEntry, nativeSizeOfCode, res, pArgs);
		}
	}
