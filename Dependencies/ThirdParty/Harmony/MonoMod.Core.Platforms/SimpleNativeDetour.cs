...
internal sealed class SimpleNativeDetour : IDisposable
{
	...
	public void ChangeTarget(IntPtr newTarget)
	{
		CheckDisposed();
		bool isEnabled;
		_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler(47, 3, out isEnabled);
		if (isEnabled)
		{
	...
	{
		bool isEnabled;
		_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler(30, 2, out isEnabled);
		if (isEnabled)
		{
