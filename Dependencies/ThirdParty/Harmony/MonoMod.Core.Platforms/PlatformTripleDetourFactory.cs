...
internal sealed class PlatformTripleDetourFactory : IDetourFactory
{
	...
	private sealed class Detour : DetourBase, ICoreDetour, ICoreDetourBase, IDisposable
	{
		private sealed class ManagedDetourBox : DetourBoxBase
		{
			...
			public void OnMethodCompiled(MethodBase method, IntPtr codeStart, IntPtr codeStartRw, ulong codeSize)
			{
				...
				lock (Sync)
				{
					...
					bool isEnabled;
					_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler(43, 4, out isEnabled);
					if (isEnabled)
					{
		...
		private static void AddRelatedDetour(MethodBase m, ManagedDetourBox cmh)
		{
			while (true)
			{
				...
				lock (orAdd)
				{
					...
					{
						bool isEnabled;
						_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogWarningStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogWarningStringHandler(115, 1, out isEnabled);
						if (isEnabled)
						{
		...
		{
			bool isEnabled;
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler(33, 2, out isEnabled);
			if (isEnabled)
			{
		...
		{
			bool isEnabled;
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler(32, 2, out isEnabled);
			if (isEnabled)
			{
	...
	private sealed class NativeDetour : DetourBase, ICoreNativeDetour, ICoreDetourBase, IDisposable
	{
		...
		{
			bool isEnabled;
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogTraceStringHandler(31, 2, out isEnabled);
			if (isEnabled)
			{
	...
	public ICoreDetour CreateDetour(CreateDetourRequest request)
	{
		...
		{
			bool isEnabled;
			_003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogWarningStringHandler message = new _003C24b3ba8a_002D00b7_002D40fc_002Da603_002D2711fa115297_003EMMDbgLog.DebugLogWarningStringHandler(66, 1, out isEnabled);
			if (isEnabled)
			{
