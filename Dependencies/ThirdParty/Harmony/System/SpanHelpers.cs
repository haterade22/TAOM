// Decompiled BCL polyfill — ref-assign patterns are valid IL but can't be expressed in safe C#
#pragma warning disable 8374 // Cannot ref-assign — decompilation artifact, IL is correct
#pragma warning disable 8174 // By-reference variable must have an initializer
...
internal static class SpanHelpers
{
	...
	public static class PerTypeValues<T>
	{
		...
		{
			T[] array = new T[1];
			return Unsafe.ByteOffset(ref ILHelpers.ObjectAsRef<T>(array), ref array[0]);
		}
	}
	...
	{
		nint num = Unsafe.ByteOffset<T>(ref src, ref Unsafe.Add(ref src, srcLength));
		nint num2 = Unsafe.ByteOffset<T>(ref dst, ref Unsafe.Add(ref dst, dstLength));
		nint num3 = Unsafe.ByteOffset(ref src, ref dst);
		bool num4;
		if (sizeof(IntPtr) != 4)
		{
			if ((ulong)(long)(IntPtr)num3 >= (ulong)(long)(IntPtr)num)
			{
				num4 = (ulong)(long)(IntPtr)num3 > (ulong)(-(long)(IntPtr)num2);
				goto IL_006f;
			}
		}
		else if ((uint)(int)(IntPtr)num3 >= (uint)(int)(IntPtr)num)
		{
			num4 = (uint)(int)(IntPtr)num3 > (uint)(-(int)(IntPtr)num2);
			goto IL_006f;
		}
		goto IL_00da;
		IL_006f:
		if (!num4 && !IsReferenceOrContainsReferences<T>())
		{
			ref byte source = ref Unsafe.As<T, byte>(ref dst);
			ref byte source2 = ref Unsafe.As<T, byte>(ref src);
			ulong num5 = (ulong)(long)(IntPtr)num;
			uint num7;
			for (ulong num6 = 0uL; num6 < num5; num6 += num7)
			{
				num7 = (uint)((num5 - num6 > uint.MaxValue) ? uint.MaxValue : (num5 - num6));
				Unsafe.CopyBlock(ref Unsafe.Add(ref source, (IntPtr)(long)num6), ref Unsafe.Add(ref source2, (IntPtr)(long)num6), num7);
			}
			return;
		}
		goto IL_00da;
		IL_00da:
		bool num8 = ((sizeof(IntPtr) == 4) ? ((uint)(int)(IntPtr)num3 > (uint)(-(int)(IntPtr)num2)) : ((ulong)(long)(IntPtr)num3 > (ulong)(-(long)(IntPtr)num2)));
		int num9 = (num8 ? 1 : (-1));
		int num10 = ((!num8) ? (srcLength - 1) : 0);
		int i;
		for (i = 0; i < (srcLength & -8); i += 8)
		{
			Unsafe.Add(ref dst, num10) = Unsafe.Add(ref src, num10);
			Unsafe.Add(ref dst, num10 + num9) = Unsafe.Add(ref src, num10 + num9);
			Unsafe.Add(ref dst, num10 + num9 * 2) = Unsafe.Add(ref src, num10 + num9 * 2);
			Unsafe.Add(ref dst, num10 + num9 * 3) = Unsafe.Add(ref src, num10 + num9 * 3);
			Unsafe.Add(ref dst, num10 + num9 * 4) = Unsafe.Add(ref src, num10 + num9 * 4);
			Unsafe.Add(ref dst, num10 + num9 * 5) = Unsafe.Add(ref src, num10 + num9 * 5);
			Unsafe.Add(ref dst, num10 + num9 * 6) = Unsafe.Add(ref src, num10 + num9 * 6);
			Unsafe.Add(ref dst, num10 + num9 * 7) = Unsafe.Add(ref src, num10 + num9 * 7);
			num10 += num9 * 8;
		}
		if (i < (srcLength & -4))
		{
		...
		while (true)
		{
			...
			if (length >= 8)
			{
				...
				if (!reference.Equals(other))
				{
					...
					{
						val = reference2;
						unsafe { reference2 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other2 = Unsafe.Add(ref searchSpace, num + 1);
					...
					{
						val = reference3;
						unsafe { reference3 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other3 = Unsafe.Add(ref searchSpace, num + 2);
					...
					{
						val = reference4;
						unsafe { reference4 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other4 = Unsafe.Add(ref searchSpace, num + 3);
					if (!reference4.Equals(other4))
					{
						...
						{
							val = reference5;
							unsafe { reference5 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
						}
						T other5 = Unsafe.Add(ref searchSpace, num + 4);
						if (!reference5.Equals(other5))
						{
							...
							{
								val = reference6;
								unsafe { reference6 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
							}
							T other6 = Unsafe.Add(ref searchSpace, num + 5);
							if (!reference6.Equals(other6))
							{
								...
								{
									val = reference7;
									unsafe { reference7 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
								}
								T other7 = Unsafe.Add(ref searchSpace, num + 6);
								if (!reference7.Equals(other7))
								{
									...
									{
										val = reference8;
										unsafe { reference8 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
									}
									T other8 = Unsafe.Add(ref searchSpace, num + 7);
			...
			else
			{
				if (length >= 4)
				{
					...
					{
						val = reference9;
						unsafe { reference9 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other9 = Unsafe.Add(ref searchSpace, num);
					...
					{
						val = reference10;
						unsafe { reference10 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other10 = Unsafe.Add(ref searchSpace, num + 1);
					...
					{
						val = reference11;
						unsafe { reference11 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other11 = Unsafe.Add(ref searchSpace, num + 2);
					...
					{
						val = reference12;
						unsafe { reference12 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
					}
					T other12 = Unsafe.Add(ref searchSpace, num + 3);
				...
				while (true)
				{
					if (length > 0)
					{
						ref T reference13 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref value));
						val = default(T);
						if (val == null)
						{
							val = reference13;
							unsafe { reference13 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref val)); }
						}
						T other13 = Unsafe.Add(ref searchSpace, num);
	...
	public static unsafe int LastIndexOf<T>(ref T searchSpace, T value, int length) where T : IEquatable<T>
	{
		while (true)
		{
			T val;
			...
			else
			{
				...
				ref T reference13 = ref Unsafe.NullRef<T>();
				T other13;
				do
				{
					if (length > 0)
					{
						length--;
						unsafe { reference13 = ref Unsafe.AsRef<T>(Unsafe.AsPointer(ref value)); }
						val = default(T);
						if (val == null)
						{
							val = reference13;
	...
	public static unsafe bool SequenceEqual<T>(ref T first, ref T second, int length) where T : IEquatable<T>
	{
		if (!Unsafe.AreSame(ref first, ref second))
		{
			nuint num = 0u;
			while (true)
			{
				...
				if (length >= 8)
				{
					...
					T other = Unsafe.Add(ref second, num);
					if (reference.Equals(other))
					{
						...
						T other2 = Unsafe.Add(ref second, num + 1);
						if (reference2.Equals(other2))
						{
							...
							T other3 = Unsafe.Add(ref second, num + 2);
							if (reference3.Equals(other3))
							{
								...
								T other4 = Unsafe.Add(ref second, num + 3);
								if (reference4.Equals(other4))
								{
									...
									T other5 = Unsafe.Add(ref second, num + 4);
									if (reference5.Equals(other5))
									{
										...
										T other6 = Unsafe.Add(ref second, num + 5);
										if (reference6.Equals(other6))
										{
											...
											T other7 = Unsafe.Add(ref second, num + 6);
											if (reference7.Equals(other7))
											{
												...
												T other8 = Unsafe.Add(ref second, num + 7);
												if (reference8.Equals(other8))
												{
													num += 8;
													continue;
				...
				else
				{
					...
					T other9 = Unsafe.Add(ref second, num);
					if (reference9.Equals(other9))
					{
						...
						T other10 = Unsafe.Add(ref second, num + 1);
						if (reference10.Equals(other10))
						{
							...
							T other11 = Unsafe.Add(ref second, num + 2);
							if (reference11.Equals(other11))
							{
								...
								T other12 = Unsafe.Add(ref second, num + 3);
								if (reference12.Equals(other12))
								{
									num += 4;
									goto IL_0377;
				...
				while (length > 0)
				{
					...
					T other13 = Unsafe.Add(ref second, num);
					if (reference13.Equals(other13))
					{
						num++;
						length--;
