...
internal static class MemorySizeExtensions
{
	...
	{
		ReadOnlySpan<byte> readOnlySpan = new byte[486]
		{
			...
			72, 128, 29, 104, 128, 30, 168, 128, 33, 72,
			128, 54, 104, 128, 55, 104, 128, 1, 42, 0,
			9, 42, 128, 2, 74, 0, 10, 74, 128, 3,
			106, 0, 11, 106, 128, 4, 170, 0, 5, 170,
			0, 12, 170, 128, 6, 10, 1, 13, 10, 129,
			28, 74, 128, 29, 106, 128, 30, 170, 128, 32,
			10, 129, 33, 74, 128, 54, 106, 128, 55, 106,
			128, 1, 44, 0, 9, 44, 128, 2, 76, 0,
			10, 76, 128, 3, 108, 0, 11, 108, 128, 4,
			172, 0, 5, 172, 0, 12, 172, 128, 6, 12,
			1, 28, 76, 128, 29, 108, 128, 30, 172, 128,
			54, 108, 128, 55, 108, 128, 28, 66, 128, 3,
			99, 0, 11, 99, 128, 28, 66, 128, 29, 99,
			128, 10, 66, 0, 2, 66, 0, 3, 99, 0,
			11, 99, 128, 4, 165, 0, 5, 165, 0, 12,
			165, 128, 28, 66, 128, 29, 99, 128, 30, 165,
			128, 53, 99, 128, 61, 165, 128, 60, 165, 0,
			54, 99, 128, 55, 99, 128, 10, 66, 0, 2,
			66, 0, 3, 99, 0, 11, 99, 128, 4, 165,
			0, 5, 165, 0, 12, 165, 128, 28, 66, 128,
			29, 99, 128, 30, 165, 128, 53, 99, 128, 61,
			165, 128, 60, 165, 0, 54, 99, 128, 55, 99,
			128, 10, 66, 0, 2, 66, 0, 3, 99, 0,
			11, 99, 128, 4, 165, 0, 5, 165, 0, 12,
			165, 128, 28, 66, 128, 29, 99, 128, 30, 165,
			128, 54, 99, 128, 53, 99, 128, 60, 165, 0,
			61, 165, 128, 55, 99, 128
		};
		...
		while (num < array2.Length)
		{
			...
			array2[num] = new MemorySizeInfo((MemorySize)num, size, elementSize, elementType, (num3 & 0x8000) != 0, num >= 112);
			num++;
			num2 += 3;
		}
		return array2;
