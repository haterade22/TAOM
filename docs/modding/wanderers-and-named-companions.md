...
| `occupation` | enum, `Wanderer` here | yes | `NotAssigned` | Puts the entry in the wanderer pool and opens the vanilla hire dialogue. A misspelling throws inside `Enum.Parse` and the whole file fails to load | `CharacterObject.cs:539-542` |
