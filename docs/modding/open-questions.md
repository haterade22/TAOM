...
- RESOLVED 2026-09-12 (#569): docs/features/career-system.md corrected; it had stated 'FillFrom does NOT clear unspecified slots'. Equipment.FillFrom (Equipment.cs:184-194) copies all 12 slots unconditionally, so an omitted slot is emptied. tools/wire_career_starter_armor.py's header states it correctly. Not in the critic notes; new finding.
