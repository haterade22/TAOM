...
- **Lord names now reach the pipeline through THREE tiers, not two; hero biographies still don't
  ...
  (179 of 1184, unchanged). Names edited directly in `characters/lords.xml` that are NOT in that
  179 are now covered by a third tier, `taom_troop_name_strings.xml`'s sibling
  `taom_lord_name_strings.xml` (988 keys, generated by `tools/generate_name_localization_strings.py`,
  which excludes whatever the XSLT tier already carries): together ~1167 of 1184 lord name keys
