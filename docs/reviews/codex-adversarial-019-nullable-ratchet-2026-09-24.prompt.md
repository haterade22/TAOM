...
- The change: git diff 7f02fc8d..improve/019-nullable-ratchet
...
CHANGED FILES (13 files changed, 154 insertions(+), 16 deletions(-)):
C#:
...
- Main/TAOM.csproj
Tests:
- TAOM.Tests/Features/Siege/SiegeCampGuardPatchTests.cs
...
Other:
- .editorconfig
- Main/Features/Siege/.editorconfig
