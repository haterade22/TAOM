...
THIS IS A SECOND REVIEW. The branch was already reviewed; the diff 41754a03..improve/014-enlistment-session-scope is the maintainer-decisions follow-up applied on top of that review. The decisions it implements are listed in the '## Maintainer decisions applied' section of git show improve/014-enlistment-session-scope:docs/reviews/deep-review-014-enlistment-session-scope-2026-09-24.md. Review this diff only; earlier commits are in scope only where the new diff changes their behaviour.
...
- The change: git diff 41754a03..improve/014-enlistment-session-scope
- Any file as the branch has it: git show improve/014-enlistment-session-scope:<path>
- The base for comparison: git show 41754a03:<path>
...
CHANGED FILES (17 files changed, 442 insertions(+), 50 deletions(-)):
C#:
- Main/Features/Enlistment/EnlistmentReconciler.cs
- Main/Features/Enlistment/Hooks/EnlistmentBehavior.cs
- Main/Features/Enlistment/Hooks/EnlistmentMenuBehavior.cs
...
- Main/SubModule.cs
Tests:
- TAOM.Tests/Features/Enlistment/CommanderLossAnnouncementTests.cs
- TAOM.Tests/Features/Enlistment/EnlistmentReconcilerTests.cs
- TAOM.Tests/Features/Enlistment/EnlistmentSessionResetTests.cs
- TAOM.Tests/Features/Enlistment/EnlistmentWaitMenuPresenterTests.cs
- TAOM.Tests/Features/Enlistment/SettlementFollowingTests.cs
Harness and docs:
- CHANGELOG.md
