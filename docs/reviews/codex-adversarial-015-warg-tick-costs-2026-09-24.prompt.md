...
- The change: git diff 7f02fc8d..improve/015-warg-tick-costs
...
CHANGED FILES (15 files changed, 529 insertions(+), 87 deletions(-)):
C#:
...
- Main/Features/Warg/WargMissionBehavior.cs
- Main/Features/Warg/WargRiderHandManager.cs
Tests:
- TAOM.Tests/Features/AdvancedCombat/BoneCheckRangeGateTests.cs
- TAOM.Tests/Features/AdvancedCombat/SpatialGridQueryTests.cs
