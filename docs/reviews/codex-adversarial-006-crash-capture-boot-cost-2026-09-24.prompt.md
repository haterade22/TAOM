...
- The change: git diff 7f02fc8d..improve/006-crash-capture-boot-cost
...
CHANGED FILES (20 files changed, 441 insertions(+), 186 deletions(-)):
C#:
...
- TAOM.Tests/Features/CrashReport/Patch37TargetShapeTests.cs
...
- docs/reference/engine/gauntletui-viewmodel-screen.md
