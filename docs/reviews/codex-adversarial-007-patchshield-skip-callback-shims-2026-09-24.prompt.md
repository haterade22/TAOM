...
- The change: git diff 7f02fc8d..improve/007-patchshield-skip-callback-shims
...
CHANGED FILES (7 files changed, 192 insertions(+), 46 deletions(-)):
C#:
...
- docs/migration/v1.5.2-impact.md
