...
- The change: git diff 7f02fc8d..improve/009-guarded-patch-category-apply
...
CHANGED FILES (16 files changed, 430 insertions(+), 159 deletions(-)):
C#:
...
- TAOM.Tests/Features/LordSpawnGuard/Patch65LandlessCultureSpawnGuardBindingTests.cs
