...
- **Agent 2 (Engine)** caught 2 by enumerating every `DisableGlobalLoadingWindow` caller in the
  installed `SandBox.GauntletUI.dll` and `TaleWorlds.MountAndBlade.GauntletUI.dll`. Its scope is
