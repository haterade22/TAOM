...
- [ue-to-bannerlord-asset-pipeline](reference/ue-to-bannerlord-asset-pipeline.md): UE / Fab kits and creature packs into Bannerlord: export, Blender normalisation, textures, materials, and (2026-09-17/18) the Fab cave troll retarget, `_anm.tpac` clip and action-set bind stages.
