...
- **`reference/engine/` — phased engine study** (18 phases, COMPLETE; one process traced end-to-end from the decompile, what/how/why). The arc: campaign object → encounter → mission → agent → render, plus every cross-cutting system + the integration meta-layer:
