...
| ShaderPrecompilation | Patch+Service | ✅ | ✅ | `Patch21_ShaderPrecompilation` | 0 | 0 | n/a | n/a | ✅ | ✅ | `OnBeforeInitialModuleScreenSetAsRoot` lifecycle (line 194). **PARKED 2026-09-25:** menu option, Patch21 and both MCM attributes commented out ([shader-precompilation](../features/shader-precompilation.md)). |
