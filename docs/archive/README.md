...
| `research-prompts-2026-04/` | One-shot Codex research prompts and comparison studies whose outputs have shipped (career system, special resources, settlement guards, etc.). |
