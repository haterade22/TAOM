...
`_shipping_build_v1.4.5` / `_v1.4.6` / `_v1.4.7` / `_v1.4.8` / `_v1.5.0` / `_v1.5.2`,
`_modules_build_v1.4.8` / `_v1.5.0` / `_v1.5.2`, `_editor_build_v1.4.5` / `_v1.4.8` / `_v1.5.2` (plus
`_editor_build_v1.4.8-kit-2026-08-19`, the Kit build that stayed on v1.4.8 while the client went to
v1.5.0), and `_categories_v1.4.5` / `_v1.4.6` / `_v1.4.7` / `_v1.4.8` / `_v1.5.2` / `_v1.5.3` for the
category tree. Native DLL snapshots: `_native/TaleWorlds.Native.v<ver>.{client,wEditor}.dll` for
v1.5.2 and v1.5.3. `_modules_build` did not exist before
...
`_diff_1.5.2_to_1.5.3_{shipping_editor,modules}.txt` those of the v1.5.3 one.
...
`v1.5.2.121216` together, and the re-baked map loaded that evening. On 2026-09-15 both moved
again, to v1.5.3.
