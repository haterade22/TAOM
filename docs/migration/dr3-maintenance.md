...
TAOM.Dependencies ships 17 classes under `Dependencies/Foundation/` that catch third-party mod runtime errors and let the game keep running. Eleven came from DR3 Phase 4 (2026-05-27), adopted from BetaDeps v0.7.5.1 (Nexus 11274) via clean-room rewrite under MIT — see `Dependencies/_Module/THIRD-PARTY-LICENSES.txt`. Six more arrived with the co-op gate (2026-08-01/02) and are TAOM-authored.
