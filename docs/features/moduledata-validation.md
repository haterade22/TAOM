...
- 2026-09-18: `SCHEMA_INVALID` added (#621): the engine-XSD layer from `tools/validate_xml_schemas.py`, run on the
  ...
  the 2026-09-15 entry below overstates what shipped: `MISSING_COLLISION_BODY` has never fired, and its hook line
  blocks nothing (#622; the pass measured 0 issues on 2026-09-18, so wiring it blocks nothing today).
