...
| Mount item | `ModuleData/LOTRLOME_items/LOTRAOM_horses.xml` → `spider_mount_a` | `is_mountable`, `<Horse monster="Monster.spider" maneuver=85 speed=65 charge_damage=15 body_length=100>` (speed 40 / maneuver 80 / charge 20 until the #615 retune, 2026-09-17), `<AdditionalMeshes><Mesh name="sk_spider_forest_c_2"/>` (the L/R split second half) |
