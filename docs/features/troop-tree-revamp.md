...
- 2026-09-18: the noble crossbow uplift below (#366) is reversed by #617. The ranged ladder sets `iron_hills_noble_scout` / `_sharpshooter` / `_veteran_sharpshooter` to the Erebor cells (Crossbow 120 / 160 / 195) and they left `SKIP_TROOP_IDS`; see `docs/features/troop-skill-balance.md`.
