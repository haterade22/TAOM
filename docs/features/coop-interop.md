...
- **No MCM settings parity: reported, not yet exchanged.** TAOM ships **254** settings across
  four MCM classes (the 284 here counted `[SettingPropertyGroup]` lines alongside the properties;
  the split is 239 in `TaomSettings`, 8 in `BattleLoadDiagnosticsSettings`, 6 in
