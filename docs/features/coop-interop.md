...
- **No MCM settings parity: reported, not yet exchanged.** TAOM ships **243** settings across
  four MCM classes (the 284 here counted `[SettingPropertyGroup]` lines alongside the properties;
  the split is 229 in `TaomSettings`, 7 in `BattleLoadDiagnosticsSettings`, 6 in
