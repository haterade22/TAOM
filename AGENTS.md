...
### Lessons From Prior Reviews (42 reviews, 126 bugs found)

Last updated: 2026-05-27 (Dependencies/Foundation review 42 — 6 confirmed findings: 2 HIGH, 2 MED, 2 LOW; 5 disputed; all confirmed bugs fixed in same session. Highest-risk suspect S4 — `ref Type[] __result` Finalizer signature legality — DISPUTED with Lib.Harmony source citation, which would have been a CRITICAL bug if confirmed wrong).
