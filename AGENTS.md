...
This section is updated by Claude after each review cycle. Last updated: 2026-05-07 (Review 37, EquipPresets port second pass — Codex caught the direct-slot-mutation architectural bypass + 8 sub-findings; full RCA in `feedback_inventory_mutations_via_vanilla_inventorylogic.md`).
