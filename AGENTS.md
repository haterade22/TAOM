...
### Lessons From Prior Reviews (38 reviews, 114 bugs found)

Last updated: 2026-05-25 (CrashReport review 38 — 8 findings: 2 HIGH, 4 MED, 2 LOW; all confirmed, all fixed).
...
This section is updated by Claude after each review cycle. Last updated: 2026-05-22 (Review 40, v1.4.5 migration — Codex caught 2 P1 + 1 P2 that 5 Claude deep-review agents missed, all fixed in same session; 4 new patterns added above. Build green, 2,323/2,325 tests pass. The dual-Claude-then-Codex review workflow caught 4 bugs in a 4-file changeset — 1 by Claude, 3 by Codex, 50/50 split).
