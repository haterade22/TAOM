...
| [014](014-enlistment-session-scope.md) | Reset Enlistment's per-session clocks and caches on load and on a new campaign | P2 | S to M | bug | none | DONE on branch `improve/014-enlistment-session-scope` (`a67792c4`, #656): D12-D16 applied; second review running |
...
| [013](013-bash-hook-prefilter.md) | Let non-git Bash calls skip the Python start-up in every Bash hook | P3 | S | dx | none | DONE on branch `improve/013-bash-hook-prefilter` (`5dcef67a`): deep review + Codex + convergence; D39/D40 follow-up queued; issue to file |
| [015](015-warg-tick-costs.md) | Cut the warg behaviour tree's per-tick resolves, allocations and native wrapper churn | P3 | S | perf | none | DONE on branch `improve/015-warg-tick-costs` (`23f6f85b`, #659): D31-D33 applied; second review running |
| [017](017-build-identity-dirty-flag.md) | Stamp a dirty-tree flag into every build and a structured build field into every crash bundle | P3 | S | dx | none | TODO, unblocked (D1; #658) |
| [018](018-composition-root-first-steps.md) | Start the feature-module composition root: shared source reader, module contract, empty list, one pilot feature | P3 | M | tech-debt | 009 | DONE on branch `improve/018-composition-root-first-steps` (`667002d8`, on 009's `4c728dac`): deep review + Codex + convergence; D48 recorded; merge after 009's new tip; issue to file |
| [019](019-nullable-ratchet.md) | Stop discarding the nullable warnings and graduate the first folder to errors | P3 | S | tech-debt | none | DONE on branch `improve/019-nullable-ratchet` (`503b933e`, #660): D34-D36 applied; second review running |
