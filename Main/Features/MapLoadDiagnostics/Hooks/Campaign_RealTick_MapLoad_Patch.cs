...
/// </summary>
[HarmonyPatch]
[HarmonyPatchCategory("Patch89_MapLoadDiagnostics")]
public static class Campaign_RealTick_MapLoad_Patch
{
    ...
    // A timestamp, not a Stopwatch: this runs every campaign frame for every player, and a
    // Stopwatch is a heap object.
    [HarmonyPrefix]
    ...
    public static void Postfix(long __state)
    {
        ...
        try
        {
            var tickMs = (Stopwatch.GetTimestamp() - __state) * 1000d / Stopwatch.Frequency;
