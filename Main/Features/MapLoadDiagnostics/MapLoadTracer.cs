...
public static class MapLoadTracer
{
    ...
    /// <summary>Restarts the timeline for a new campaign in the same process (see
    /// <see cref="MapLoadDiagnosticsBehavior"/>); sequence numbers and offsets start from zero again.</summary>
