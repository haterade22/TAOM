...
/// absent or not yet initialized, so the setting falls back to its compiled default — on.
///
...
{
    /// <summary>
    /// Pure seam so the fail direction is testable without touching the MCM static. The <c>?? true</c>
